    ...
    return(
        <div className="absolute z-10   bg-black/90 inset-0 flex items-center justify-center">
            <div className="p-[3px] scale-box flex justify-center items-center w-[60%] h-[50%] bg-gradient-to-r from-green-400 to-blue-400 rounded-2xl">
                <div  className="flex flex-col lg:flex-row rounded-2xl opacity-100 bg-gradient-to-br from-40% w-[100%] h-[100%]   from-[#3b5228]  via-black to-[#136a79]  text-white text-6xl">
                    <div className="flex flex-col lg:w-1/2 h-full">
                        ...
                        <div className="flex  pl-4 w-[97%] h-[50%] lg:h-[100%] ">
                    ...
                    <div className="w-full  lg:w-1/2 h-1/3 lg:h-auto">
