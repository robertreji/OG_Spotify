...
export default function  ArtistPlaylist()
{
   ...
   async function getDuration()
    ...
    return(
        <div className="relative bg-gradient-to-b from-[#ffffff26] to-[#ffffff8]   overflow-auto  flex flex-col lg:mr-2 pt-8 rounded-md lg:w-[75%] p-4  h-[95%]">
            ...
            <div className=" overflow-auto w-full  h-[90%]">
                <div className="overflow-x-auto scrollbar-hide ">
                    <div className="flex relative flex-col gap-2   justify-start  w-auto">
                          <div className="grid px-8 grid-cols-[90px_2fr_1fr] mt-10 mb-4 pl-2 text-[#a7a7a7] ">
                                        <p>
                                            <b  className="lg:ml-4">#</b> 
                                        </p>
                                        <p>Song </p>
                                        <p>Listeners</p>
                                        <p className="hidden lg:block" >duration
                                    ...
                                    </div>
                       {
                        ...
                        ?ArtistPlaylist.map((item,index)=>
                            ...
                            {
                                const sec="00"
                            return <div  className="hover:cursor-pointer grid  grid-cols-[10%_2fr_1fr] lg:grid-cols-[90px_1fr_1fr_90px]  items-center hover:bg-[#ffffff10]">
                                <b className="font-semibold font-serif text-2xl text-white flex pl lg:pl-6">{index+1}</b>
                                <SongItem imgClassWrapper={"overflow-hidden rounded-xl bg-amber-800 w-[23%] h-[95%] lg:w-[10%]"}
                                ...
                                <b className=" hidden lg:block text-md text-white">{allduratrion?iso8601Duration.parse(allduratrion[index].contentDetails.duration).minutes:0} : {allduratrion?iso8601Duration.parse(allduratrion[index].contentDetails.duration).seconds:`${sec}`}</b>
                                </div> 
                            })
